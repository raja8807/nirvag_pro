    ...
    <section className={styles.integrationSection} id="Integrations">
      <div className={styles.integrationContainer}>
        <div className={styles.integrationRow}>
          <h3 className={styles.title} data-aos="fade-left">
            ...
            <div className={styles.caseStudyCard} data-aos="fade-up">
              ...
              <div className={styles.caseStudyTextWrapper}>
                <h4 className={styles.caseStudyTitle}>
                  {INTEGRATIONS_CONTENT.caseStudy.title}
                </h4>
                ...
                <div className={styles.statsWrapper}>
                  <div className={styles.statBlock}>
                    ...
                    <div className={styles.statNumber}>
                      {INTEGRATIONS_CONTENT.caseStudy.stat1.value}
                      <span>{INTEGRATIONS_CONTENT.caseStudy.stat1.symbol}</span>
                    </div>
                  </div>
                  ...
                  <div className={styles.statBlock}>
                    ...
                    <div className={styles.statNumber}>
                      {INTEGRATIONS_CONTENT.caseStudy.stat2.value}
                      <span>{INTEGRATIONS_CONTENT.caseStudy.stat2.symbol}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className={styles.linkWrapper}>
                  <Link href="/about" className={styles.ternaryButton}>
                    <div className={styles.buttonSmall}>
                      {INTEGRATIONS_CONTENT.caseStudy.button}
                    </div>
